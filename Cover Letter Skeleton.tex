...
\setmainfont[Scale=.95]{Avenir Book}
...
\def\Who{Adam H. Sparks} % Your name
\def\What{, PhD} % Your title
\def\Where{Crop and Environmental Sciences Division\\International Rice Research Institute} % Your department/institution
\def\Address{DAPO Box 7777} % Your address
\def\CityZip{Metro Manila, 1301 Philippines} % Your city, zip code, country, etc
\def\Email{E-mail: adamhsparks@gmail.com} % Your email address
\def\TEL{Phone: +63 908-182-8012} % Your phone number
\def\URL{URL: http://www.about.me/adamhsparks} % Your URL
...
\includegraphics[scale=.4]{/Users/asparks/Dropbox/Signature/Sparks_Signature.png}
}
