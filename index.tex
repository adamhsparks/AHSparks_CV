...
\quote{I have extensive research experience in crop health modelling in non-profit and academic organisations.}
...
\item
  Others: Git, GitHub Actions, Docker, Travis CI, LaTeX, Markdown and RMarkdown
\end{itemize}
...
\detailedsection{\detaileditem{Australian Bureau of Meteorology (BOM) weather data API Client for R}{CRAN}{bomrang}{}{\empty}\detaileditem{Climate Hazards Group InfraRed Precipitation with Station Data (CHIRPS) API data client for R}{CRAN}{chirps}{}{\empty}\detaileditem{University of East Anglia Climate Research Unit (CRU) climate data API client for R}{CRAN}{getCRUCLdata}{}{\empty}\detaileditem{Global Surface Summary of the Day (GSOD) Weather Data API Client for R}{CRAN}{GSODR}{}{\empty}\detaileditem{Analysis of plant pathogen pathotype complexities, distributions and diversity in R}{CRAN}{hagis}{}{\empty}\detaileditem{NASA POWER Global Meteorology, Surface Solar Energy and Climatology Data API Client for R}{CRAN}{nasapower}{}{\empty}}
...
\detailedsection{\detaileditem{Software Carpentries R for Reproducible Scientific Analysis}{2020}{QCIF (Queensland Cyber Infrastructure Foundation)}{Zoom}{\item{Lead Instructor}}\detaileditem{Data Carpentries Data Organization in Spreadsheets for Ecologists}{2019}{FAO and Cambodia GDA}{Phnom Penh, KHM}{\item{Organiser and Lead Instructor}}\detaileditem{Software Carpentries R for Reproducible Scientific Analysis}{2019}{University of Southern Queensland}{Toowoomba, Queensland, AUS}{\item{Co-organiser and Instructor}}\detaileditem{R for Scientific Analysis}{2019}{Southern Cross University}{Lismore, New South Wales, AUS}{\item{Lead Instructor}}\detaileditem{Software Carpentries Python Workshop}{2019}{University of Southern Queensland}{Springfield, Queensland, AUS}{\item{Helper}}\detaileditem{R Markdown for Scientists}{2019}{Australasian Plant Pathology Society}{Melbourne, Victoria, AUS}{\item{Organiser and Lead Instructor}}\detaileditem{Software Carpentries R for Reproducible Scientific Analysis}{2018}{University of Southern Queensland}{Toowoomba, Queensland, AUS}{\item{Co-organiser and Instructor}}\detaileditem{Software Carpentries Python Workshop}{2018}{University of Southern Queensland}{Springfield, Queensland, AUS}{\item{Helper}}\detaileditem{Software Carpentries R for Reproducible Scientific Analysis}{2017}{University of Southern Queensland}{Toowoomba, Queensland, AUS}{\item{Helper}}\detaileditem{Workshop on Integrated Rice Disease Management and Training on Statistical Analysis}{2012}{Bureau of Rice Research and Development, Rice Department, Bangkok}{Chiang Mai, THL}{\item{Co-organiser and Instructor}}}
